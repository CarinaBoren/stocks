...
export class LineChartComponent implements OnChanges {
  ...
  public barChartData =[];
  public barChartOptions = {layout: { padding: {left:10, right:10, top:50, bottom:0}}}
      ...
      case 7:
        ...
        case 8:
          ...
          case 9:
            ...
            case 10:
              return new Date(currentDate.getFullYear() - 50, currentDate.getMonth(), currentDate.getDate());
              default:
                return new Date(currentDate.getFullYear(), 0, 1);
...
updateGraph(): void {
  ...
  this.stockService.getStockPricesByDateAndId(this.stockId, fromDate).subscribe({
    next: stockPrices => {
      this.barChartData = [{data: stockPrices.stockPricesList.map(x => x.l), label: 'close', fill: false, pointRadius: 0, color:'#000000'},
                {data: stockPrices.stockPricesList.map(x => x.h), label: 'high', fill: false, pointRadius: 0}];
